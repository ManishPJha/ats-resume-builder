      ...
      <div className="relative bg-gradient-to-br from-blue-50 to-purple-50 p-8 rounded-lg shadow-2xl w-96 max-w-full mx-4">
        ...
        <div className="mb-6">
          ...
          <input
            ...
            className="w-full px-4 py-3 border border-gray-300 text-black rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-300"
